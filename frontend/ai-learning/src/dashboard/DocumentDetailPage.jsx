    ...
    const handleExplainConcept = async () => {
        try {
            ...
            setChatMessages([
                ...
                { role: "assistant", content: data.data?.explanation || data.data?.answer || "Explanation generated successfully" },
            ]);
            setConceptText("");
        } catch (err) {
    ...
    const handleChatSubmit = async (e) => {
        ...
        try {
            ...
            setChatMessages((prev) => [
                ...prev,
                { role: "assistant", content: data.data?.answer || data.data?.response || "Message received successfully" },
            ]);
        } catch (err) {
            setChatMessages((prev) => [
                ...prev,
